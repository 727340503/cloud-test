...
public class UserStampHistory extends BaseModel {
	...
	public enum UserStampHistoryType {
		COLLECT_STAMPS(1,"Collect stamps"), TRANSFER_OUT_STAMPS(2,"Transfer out stamps"), TRANSFER_IN_STAMPS(3,"Transfer in stamps"), REDEEM(4,"Redemption"),
		RESERVATION(5,"Reservation"), SYSTEM_IN_STAMPS(6,"System in stamps"), SYSTEM_OUT_STAMPS(7,"System out stamps"), GRANT(8,"Free stamps");
