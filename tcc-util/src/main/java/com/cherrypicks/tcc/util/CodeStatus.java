...
public abstract class CodeStatus {
    ...
    // user coupon expired
    public static final int USER_COUPON_EXPIRED_ERROR = 10413;
    ...
    // sns not found
    public static final int SNS_NOT_FOUND_ERROR = 10436;
    ...
    public static final int FACE_BOOK_EXIST_ERROR = 10491;
    ...
    public static final int COUPON_PENDING_ERROR = 10496;

    public static final int COUPON_EXPIRED_ERROR = 10497;
    ...
    public static final int NOT_STAMPS_TYPE_COUPON_ERROR = 10500;
    ...
    public static final int COUPON_IN_ACTIVE_ERROR = 20301;

    public static final int INVALID_ADJUSTSTAMP_TYPE = 20303;

    public static final int USER_STORE_NOT_FOUND_ERROR = 20304;
