...
public final class Constants {
    ...
    public static final String KEEPER_CREATE_BY_API = "KEEPER_API_CREATE";
    public static final String KEEPER_UPDATE_BY_API = "KEEPER_API_UPDATE";
    public static final String ALGORITHM_AES = "AES";
    public static final String LINE_SEPARATOR = System.getProperty("line.separator");
    public static final String SMS_FROM = "TCC_SHOPPO";
...
/*    public static class RoleKey {
	...
	public static final String COLLECT_COUPON_REPORT = "collect_coupon_report";
	public static final String USER_REPORT = "User report - %s_%s-%s";
	public static final String REDEEM_COUPON_REPORT = "redeem_coupon_report";
	...
	public static final String TRANS_STAMP_LOG = "posTransStamp-log";
	public static final String REDEEM_GIFT_LOG = "posRedeemGift-log";
	public static final String RESERVATION_LOG = "posReservationChangeStatus-log";
